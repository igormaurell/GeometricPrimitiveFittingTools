...
if __name__ == '__main__':
    ...
    for format in formats:
        parameters[format] = {'normalization': {}, 'input': {}, 'output': {}}
        ...
        parameters[format]['input']['dataset_folder_name'] = input_dataset_format_folder_name
        data_format_folder_name = join(input_dataset_format_folder_name, data_folder_name)
        parameters[format]['input']['data_folder_name'] = data_format_folder_name
        transform_format_folder_name = join(input_dataset_format_folder_name, transform_folder_name)
        parameters[format]['input']['transform_folder_name'] = transform_format_folder_name
        if delete_old_data:
            if exists(input_dataset_format_folder_name):
                rmtree(input_dataset_format_folder_name)
            makedirs(input_dataset_folder_name, exist_ok=True)
